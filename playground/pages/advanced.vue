    ...
    <div class="grid grid-cols-2 gap-4">
      <UCard>
        ...
        <p class="text-xs text-gray-500 mb-2">
          Consent categories with metadata from c15t.
        </p>
        <div class="space-y-1">
          <div
      ...
      <UCard>
        ...
        <p class="text-xs text-gray-500 mb-2">
          Detected jurisdiction from geo-IP.
        </p>
      ...
      <UCard>
        ...
        <p class="text-xs text-gray-500 mb-2">
          Privacy/cookie policy URLs if configured.
        </p>
      ...
      <UCard>
        ...
        <p class="text-xs text-gray-500 mb-2">
          Consent record metadata for compliance.
        </p>
    ...
    <UCard>
      ...
      >
        <div
          ...
          :key="i"
          class="text-xs font-mono p-1 bg-gray-50 rounded"
        >
          {{ entry }}
        </div>
      </div>
